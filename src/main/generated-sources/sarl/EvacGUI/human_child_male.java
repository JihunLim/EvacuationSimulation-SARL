...
public class human_child_male extends Agent {
  ...
  private void $behaviorUnit$SimulStart$0(final SimulStart occurrence) {
    ...
    final AgentTask directTask = _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.task("wait-task");
  ...
  private void $behaviorUnit$Destroy$2(final Destroy occurrence) {
    ...
    A_Escape _a_Escape = new A_Escape();
    _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_2.emit(_a_Escape, superScope);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    human_child_male other = (human_child_male) obj;
    ...
    if (other.agent_id != this.agent_id)
      return false;
    if (Float.floatToIntBits(other.currentX) != Float.floatToIntBits(this.currentX))
      return false;
  ...
  @SyntheticMember
  public human_child_male(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public human_child_male(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
